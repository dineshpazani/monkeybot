    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul className="nav">
            ...
            <div className="profile-desc">
              <div className="profile-pic">
                ...
                <div className="profile-name">
                  <h5 className="mb-0 font-weight-normal"><Trans>dinesh pazani</Trans></h5>
          ...
          <li className={ this.isPathActive('/angel') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <Link className="nav-link" to="/angel">
              <span className="menu-icon"><i className="mdi mdi-airplay"></i></span>
              <span className="menu-title"><Trans>Angel</Trans></span>
            </Link>
          </li>  
          <li className={ this.isPathActive('/binance') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <Link className="nav-link" to="/binance">
              <span className="menu-icon"><i className="mdi mdi-ubuntu"></i></span>
              <span className="menu-title"><Trans>Binance</Trans></span>
            </Link>
          </li>  
          <li className={ this.isPathActive('/admin') ? 'nav-item menu-items active' : 'nav-item menu-items' }>
            <Link className="nav-link" to="/admin">
              <span className="menu-icon"><i className="mdi mdi-ubuntu"></i></span>
              <span className="menu-title"><Trans>Admin</Trans></span>
            </Link>
          </li>          
